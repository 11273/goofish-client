    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "收藏示例", link: "/examples/favor" },
          { text: "订单示例", link: "/examples/order" },
          { text: "IM 示例", link: "/examples/im" },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "🔍 搜索示例", link: "/examples/search" },
          { text: "📦 商品示例", link: "/examples/item" },
          { text: "❤️ 收藏示例", link: "/examples/favor" },
          { text: "📋 订单示例", link: "/examples/order" },
          { text: "💬 IM 示例", link: "/examples/im" },
          { text: "🔐 认证示例", link: "/examples/authentication" },
        ],
